 ...
 * Once a Game is created or read, it is loaded into the instance of DAO and can be retrieved directly.
 */
@Repository
    ...
    public Game get(int gameId) {
        try {
            ...
            if (blob == null || !blob.exists()) {
                throw new GameDaoException("Game not found", new Exception());
            }
